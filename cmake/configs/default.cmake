...
hunter_config(AngelScript VERSION 1.0.0)
...
hunter_config(Bullet VERSION 1.0.0-p0)
hunter_config(Civetweb VERSION 1.0.0)
...
hunter_config(Detour VERSION 1.0.0-p0)
hunter_config(DetourCrowd VERSION 1.0.0-p0)
hunter_config(DetourTileCache VERSION 1.0.0-p0)
hunter_config(Eigen VERSION 3.2.4-p0)
hunter_config(Expat VERSION 2.1.1)
hunter_config(GLEW VERSION 1.0.0)
...
hunter_config(JO VERSION 1.0.0-p0)
...
hunter_config(LibCpuId VERSION 1.0.0)
hunter_config(Libssh2 VERSION 1.7.0)
hunter_config(Lua VERSION 5.3.2)
hunter_config(LZ4 VERSION 1.0.0-p2)
hunter_config(MojoShader VERSION 1.0.0)
hunter_config(Mustache VERSION 1.0.0)
...
hunter_config(PugiXml VERSION 1.0.0-p1)
hunter_config(Recast VERSION 1.0.0)
...
hunter_config(StanHull VERSION 1.0.0-p0)
...
hunter_config(kNet VERSION 1.0.0-p0)
